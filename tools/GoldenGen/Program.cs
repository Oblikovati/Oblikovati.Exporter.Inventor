...
namespace Oblikovati.Exporter.Inventor.GoldenGen
{
    ...
    internal static class Program
    {
        ...
        private static IEnumerable<InventorDocument> Fixtures()
        {
            ...
            yield return InventorSampleParts.OffsetHoledBoxPart();
            ...
            yield return InventorSampleParts.ArcRadiusPart();
            ...
            yield return InventorSampleParts.EllipticalArcPart();
            yield return InventorSampleParts.ConstraintSamplerPart();
        }
    }
}
